...
class UnitCell {
    ...
    beta;
    gamma;
    constructor(a = 1.0, b = 1.0, c = 1.0, alpha = 90.0, beta = 90.0, gamma = 90.0) {
        this.a = a;
        this.b = b;
        this.c = c;
        this.alpha = alpha;
    ...
    getVolume() {
        ...
        const cosProd = Math.cos(alphaRad) * Math.cos(betaRad) * Math.cos(gammaRad);
        const sinProd = Math.sin(alphaRad) * Math.sin(betaRad) * Math.sin(gammaRad);
        const volume = this.a *
            this.b *
            this.c *
     ...
     */
    clone() {
        return new UnitCell(this.a, this.b, this.c, this.alpha, this.beta, this.gamma);
    }
    /**
     * Convert to JSON
     */
